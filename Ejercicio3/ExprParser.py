...
class ExprParser ( Parser ):
    ...
    def programa(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not (_la==ExprParser.T__1 or _la==ExprParser.ID):
                    break
    ...
    class SentenciaContext(ParserRuleContext):
        ...
        def ifElseStmt(self):
            return self.getTypedRuleContext(ExprParser.IfElseStmtContext,0)
    ...
    class IfElseStmtContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return ExprParser.RULE_ifElseStmt
    ...
    class IfElseContext(IfElseStmtContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a ExprParser.IfElseStmtContext
    ...
    def ifElseStmt(self):
        ...
        localctx = ExprParser.IfElseStmtContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while _la==ExprParser.T__1 or _la==ExprParser.ID:
                self.state = 30
                self.sentencia()
                self.state = 32
                self._errHandler.sync(self)
    ...
    class CondicionSimpleContext(CondicionContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a ExprParser.CondicionContext
            super().__init__(parser)
            self.op = None # Token
            self.copyFrom(ctx)
    ...
    def condicion(self):
        ...
        self._la = 0 # Token type
        try:
            localctx = ExprParser.CondicionSimpleContext(self, localctx)
            self.enterOuterAlt(localctx, 1)
            self.state = 54
            ...
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << ExprParser.T__7) | (1 << ExprParser.T__8) | (1 << ExprParser.T__9) | (1 << ExprParser.T__10))) != 0)):
    ...
    class AssignContext(AsignacionContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a ExprParser.AsignacionContext
            super().__init__(parser)
            self.copyFrom(ctx)
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = ExprParser.MulDivContext(self, ExprParser.ExpresionContext(self, _parentctx, _parentState))
                        ...
                        localctx.op = self._input.LT(1)
                        _la = self._input.LA(1)
                        if not(_la==ExprParser.T__12 or _la==ExprParser.T__13):
                            localctx.op = self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
                        ...
                        localctx = ExprParser.AddSubContext(self, ExprParser.ExpresionContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expresion)
                        self.state = 75
                        ...
                        localctx.op = self._input.LT(1)
                        _la = self._input.LA(1)
                        if not(_la==ExprParser.T__14 or _la==ExprParser.T__15):
                            localctx.op = self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
